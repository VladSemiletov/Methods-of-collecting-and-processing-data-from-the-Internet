...
# клиент Монго и функция по добавлению в базу данных с проверкой
...
while True:
    ...
    for vac in vacancies:
        ...
        vac_price_info = vac.find(
            'div', attrs={'class', 'vacancy-serp-item__row_header'})
        vac_price = vac_price_info.find(
            'div', attrs={'class', 'vacancy-serp-item__sidebar'})
